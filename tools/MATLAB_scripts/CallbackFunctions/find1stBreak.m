...
% Get indx of first break relative of a threshold.
% INPUT:
% tempData      : double [nx1] containing data about field of loaded out-File
% tempAxis      : double [nx1] - containing information temporal axis
% nonZeroThresh : double - criterion for threshold of first break relative to first negative minimum
%
% OUTPUT:
% firstBreak        : first break time
% firstMinimumTime  : time of first minimum
% maxAmplitude      : time of maximum amplitude
% idx               : idx of first break time in tempData
