...
% Delete/Hide/Show Lines in a figure containing two axis objects (time and
% frequency domain).
%
% INPUT:
% src,event     : mandatory inputs for callback functions, see Matlab Docs
% timePlot      : axis object containing traces in time domain
% freqPlot      : axis object containing traces in frequency domain
% mode1         : character - 'hide','show','delete'
% mode2         : character - 'select' (from GUI) or 'filter' (let user type in text)
